...
class getSylius_Form_Type_DataTransformer_ProductsToCodesService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.form.type.data_transformer.products_to_codes'] = new \Sylius\Bundle\CoreBundle\Form\DataTransformer\ProductsToCodesTransformer(($container->services['sylius.repository.product'] ?? self::getSylius_Repository_ProductService($container)));
    }
}
