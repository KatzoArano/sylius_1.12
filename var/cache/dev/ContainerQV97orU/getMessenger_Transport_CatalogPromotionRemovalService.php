...
class getMessenger_Transport_CatalogPromotionRemovalService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.catalog_promotion_removal'] = $a->createTransport($container->getEnv('resolve:SYLIUS_MESSENGER_TRANSPORT_CATALOG_PROMOTION_REMOVAL_DSN'), ['transport_name' => 'catalog_promotion_removal'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
