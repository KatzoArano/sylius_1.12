...
class getSecurity_Authenticator_RememberMe_AdminService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.remember_me.admin'])) {
            return $container->privates['security.authenticator.remember_me.admin'];
        }

        return $container->privates['security.authenticator.remember_me.admin'] = new \Symfony\Component\Security\Http\Authenticator\RememberMeAuthenticator($a, $container->getEnv('APP_SECRET'), ($container->services['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), 'APP_ADMIN_REMEMBER_ME', ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)));
    }
}
