...
class getSylius_ImageUploaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.image_uploader'] = new \Sylius\Component\Core\Uploader\ImageUploader(($container->services['Sylius\\Component\\Core\\Filesystem\\Adapter\\FlysystemFilesystemAdapter'] ?? $container->load('getFlysystemFilesystemAdapterService')), ($container->services['Sylius\\Component\\Core\\Generator\\ImagePathGeneratorInterface'] ??= new \Sylius\Component\Core\Generator\UploadedImagePathGenerator()));
    }
}
