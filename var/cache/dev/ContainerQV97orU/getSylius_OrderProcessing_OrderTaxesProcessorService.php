...
class getSylius_OrderProcessing_OrderTaxesProcessorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.order_processing.order_taxes_processor'] = new \Sylius\Component\Core\OrderProcessing\OrderTaxesProcessor(($container->services['sylius.provider.channel_based_default_zone_provider'] ??= new \Sylius\Bundle\CoreBundle\Provider\ChannelBasedDefaultTaxZoneProvider()), ($container->services['sylius.zone_matcher'] ?? self::getSylius_ZoneMatcherService($container)), $a, ($container->services['sylius.taxation_address_resolver'] ??= new \Sylius\Component\Core\Resolver\TaxationAddressResolver(false)));
    }
}
