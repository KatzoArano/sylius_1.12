...
class getSylius_Form_DataMapper_OrderItemQuantityService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.form.data_mapper.order_item_quantity'] = new \Sylius\Bundle\OrderBundle\Form\DataMapper\OrderItemQuantityDataMapper(($container->services['sylius.order_item_quantity_modifier.limiting'] ?? $container->load('getSylius_OrderItemQuantityModifier_LimitingService')), new \Symfony\Component\Form\Extension\Core\DataMapper\DataMapper());
    }
}
