 ...
 */
class getSylius_Api_SearchPaymentFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'sylius.api.search_payment_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.api.search_payment_filter'])) {
            return $container->services['sylius.api.search_payment_filter'];
        }

        return $container->services['sylius.api.search_payment_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), NULL, $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['state' => 'exact', 'order.channel.code' => 'exact'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? self::getApiPlatform_IdentifiersExtractor_CachedService($container)), ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
