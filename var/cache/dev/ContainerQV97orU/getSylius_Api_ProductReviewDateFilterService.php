 ...
 */
class getSylius_Api_ProductReviewDateFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'sylius.api.product_review_date_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.api.product_review_date_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\OrderFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), NULL, 'order', ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['createdAt' => ''], ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
