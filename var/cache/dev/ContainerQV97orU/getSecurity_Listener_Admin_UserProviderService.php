...
class getSecurity_Listener_Admin_UserProviderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.listener.admin.user_provider'])) {
            return $container->privates['security.listener.admin.user_provider'];
        }

        return $container->privates['security.listener.admin.user_provider'] = new \Symfony\Component\Security\Http\EventListener\UserProviderListener($a);
    }
}
