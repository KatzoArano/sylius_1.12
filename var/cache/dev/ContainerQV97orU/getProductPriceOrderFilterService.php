 ...
 */
class getProductPriceOrderFilterService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Bundle/ApiBundle/Filter/Doctrine/ProductPriceOrderFilter.php';

        return $container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\ProductPriceOrderFilter'] = new \Sylius\Bundle\ApiBundle\Filter\Doctrine\ProductPriceOrderFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
