...
class getSonata_Block_Exception_Renderer_InlineDebugService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sonata.block.exception.renderer.inline_debug'] = new \Sonata\BlockBundle\Exception\Renderer\InlineDebugRenderer(($container->services['twig'] ?? self::getTwigService($container)), '@SonataBlock/Block/block_exception_debug.html.twig', true, true);
    }
}
