...
class getMessenger_RoutableMessageBusService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.routable_message_bus'] = new \Symfony\Component\Messenger\RoutableMessageBus(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'sylius_refund_plugin.command_bus' => ['privates', 'debug.traced.sylius_refund_plugin.command_bus', 'getDebug_Traced_SyliusRefundPlugin_CommandBusService', false],
            'sylius_refund_plugin.event_bus' => ['privates', 'debug.traced.sylius_refund_plugin.event_bus', 'getDebug_Traced_SyliusRefundPlugin_EventBusService', false],
        ], [
            'sylius.command_bus' => '?',
            'sylius.event_bus' => '?',
            'sylius_default.bus' => '?',
