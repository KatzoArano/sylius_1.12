...
class getSecurity_Firewall_Map_Context_ShopService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->services['security.token_storage'] ?? self::getSecurity_TokenStorageService($container));
        ...
        }, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), $a, 'shop', ($container->privates['security.authenticator.form_login.shop'] ?? $container->load('getSecurity_Authenticator_FormLogin_ShopService')), NULL, NULL, ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, ($container->privates['debug.security.event_dispatcher.shop'] ?? self::getDebug_Security_EventDispatcher_ShopService($container)), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'sylius_shop_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('shop', 'security.user_checker', '.security.request_matcher.TmQBfmV', true, false, 'sylius.shop_user_provider.email_or_name_based', 'shop', 'security.authenticator.form_login.shop', NULL, NULL, ['switch_user', 'form_login', 'remember_me'], ['role' => 'ROLE_ALLOWED_TO_SWITCH', 'parameter' => '_switch_user', 'target_route' => NULL], ['path' => 'sylius_shop_logout', 'target' => 'sylius_shop_homepage', 'invalidate_session' => false, 'enable_csrf' => NULL, 'csrf_token_id' => 'logout', 'csrf_parameter' => '_csrf_token', 'clear_site_data' => [], 'delete_cookies' => []]));
    }
}
