...
class getWebpackEncore_EntrypointLookup_CacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] = new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['_default' => (\dirname(__DIR__, 4).'/public/build/default/entrypoints.json'), 'admin' => (\dirname(__DIR__, 4).'/public/build/admin/entrypoints.json'), 'shop' => (\dirname(__DIR__, 4).'/public/build/shop/entrypoints.json'), 'app.admin' => (\dirname(__DIR__, 4).'/public/build/app/admin/entrypoints.json'), 'app.shop' => (\dirname(__DIR__, 4).'/public/build/app/shop/entrypoints.json')], ($container->targetDir.''.'/webpack_encore.cache.php'));
    }
}
