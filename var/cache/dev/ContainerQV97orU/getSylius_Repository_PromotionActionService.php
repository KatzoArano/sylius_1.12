...
class getSylius_Repository_PromotionActionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.repository.promotion_action'])) {
            return $container->services['sylius.repository.promotion_action'];
        }

        return $container->services['sylius.repository.promotion_action'] = $a->getRepository('App\\Entity\\Promotion\\PromotionAction');
    }
}
