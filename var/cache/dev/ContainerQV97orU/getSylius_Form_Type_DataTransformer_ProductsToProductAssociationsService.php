...
class getSylius_Form_Type_DataTransformer_ProductsToProductAssociationsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.form.type.data_transformer.products_to_product_associations'] = new \Sylius\Bundle\ProductBundle\Form\DataTransformer\ProductsToProductAssociationsTransformer(($container->services['sylius.factory.product_association'] ??= new \Sylius\Component\Resource\Factory\Factory('App\\Entity\\Product\\ProductAssociation')), ($container->services['sylius.repository.product'] ?? self::getSylius_Repository_ProductService($container)), ($container->services['sylius.repository.product_association_type'] ?? $container->load('getSylius_Repository_ProductAssociationTypeService')));
    }
}
