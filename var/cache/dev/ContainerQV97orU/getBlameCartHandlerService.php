...
class getBlameCartHandlerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Sylius\\Bundle\\ApiBundle\\CommandHandler\\Cart\\BlameCartHandler'] = new \Sylius\Bundle\ApiBundle\CommandHandler\Cart\BlameCartHandler(($container->services['sylius.repository.shop_user'] ?? $container->load('getSylius_Repository_ShopUserService')), ($container->services['sylius.repository.order'] ?? self::getSylius_Repository_OrderService($container)), $a);
    }
}
