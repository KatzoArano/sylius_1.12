...
class getDoctrine_Migrations_DependencyFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addMigrationsDirectory('PayPlug\\SyliusPayPlugPlugin\\Migrations', (\dirname(__DIR__, 4).'/vendor/payplug/sylius-payplug-plugin/src/Migrations'));
        $a->addMigrationsDirectory('Sylius\\RefundPlugin\\Migrations', (\dirname(__DIR__, 4).'/vendor/sylius/refund-plugin/src/Migrations'));
