 ...
 */
class getDebug_Security_Firewall_Authenticator_ShopService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['security.authenticator.manager.shop'] ?? $container->load('getSecurity_Authenticator_Manager_ShopService'));
        ...
        return $container->privates['debug.security.firewall.authenticator.shop'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener($a));
    }
}
