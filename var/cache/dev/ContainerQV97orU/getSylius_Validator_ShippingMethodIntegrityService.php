...
class getSylius_Validator_ShippingMethodIntegrityService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.validator.shipping_method_integrity'] = new \Sylius\Bundle\CoreBundle\Validator\Constraints\OrderShippingMethodEligibilityValidator(($container->services['sylius.shipping_method_eligibility_checker'] ?? self::getSylius_ShippingMethodEligibilityCheckerService($container)));
    }
}
