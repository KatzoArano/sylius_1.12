...
class getProductUpdatedListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Sylius\\Bundle\\CoreBundle\\CatalogPromotion\\Listener\\ProductUpdatedListener'] = new \Sylius\Bundle\CoreBundle\CatalogPromotion\Listener\ProductUpdatedListener(($container->services['sylius.repository.product'] ?? self::getSylius_Repository_ProductService($container)), ($container->services['Sylius\\Bundle\\CoreBundle\\CatalogPromotion\\Processor\\ProductCatalogPromotionsProcessorInterface'] ?? $container->load('getProductCatalogPromotionsProcessorInterfaceService')), $a);
    }
}
