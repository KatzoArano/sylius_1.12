...
class getMessenger_Transport_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.main'])) {
            return $container->privates['messenger.transport.main'];
        }

        return $container->privates['messenger.transport.main'] = $a->createTransport($container->getEnv('resolve:SYLIUS_MESSENGER_TRANSPORT_MAIN_DSN'), ['transport_name' => 'main'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
