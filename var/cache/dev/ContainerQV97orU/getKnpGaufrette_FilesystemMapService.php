...
class getKnpGaufrette_FilesystemMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['knp_gaufrette.filesystem_map'] = new \Knp\Bundle\GaufretteBundle\FilesystemMap(['sylius_image' => ($container->services['gaufrette.sylius_image_filesystem'] ?? $container->load('getGaufrette_SyliusImageFilesystemService')), 'sylius_refund_credit_memo' => ($container->services['gaufrette.sylius_refund_credit_memo_filesystem'] ?? $container->load('getGaufrette_SyliusRefundCreditMemoFilesystemService'))]);
    }
}
