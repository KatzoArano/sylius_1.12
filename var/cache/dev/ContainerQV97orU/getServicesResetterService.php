    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            if (isset($container->privates['debug.security.firewall.authenticator.new_api_admin_user'])) {
                yield 'debug.security.firewall.authenticator.new_api_admin_user' => ($container->privates['debug.security.firewall.authenticator.new_api_admin_user'] ?? null);
            }
            if (isset($container->privates['debug.security.firewall.authenticator.new_api_shop_user'])) {
                yield 'debug.security.firewall.authenticator.new_api_shop_user' => ($container->privates['debug.security.firewall.authenticator.new_api_shop_user'] ?? null);
            }
        ...
        }, fn () => 0 + (int) (isset($container->services['request_stack'])) + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (isset($container->privates['cache.annotations'])) + (int) (isset($container->privates['cache.property_info'])) + (int) (isset($container->privates['cache.messenger.restart_workers_signal'])) + (int) (isset($container->privates['mailer.message_logger_listener'])) + (int) (isset($container->privates['translation.locale_switcher'])) + (int) (isset($container->services['debug.stopwatch'])) + (int) (isset($container->services['event_dispatcher'])) + (int) (isset($container->privates['debug.log_processor'])) + (int) (isset($container->privates['session_listener'])) + (int) (isset($container->privates['form.choice_list_factory.cached'])) + (int) (isset($container->services['cache.validator_expression_language'])) + (int) (isset($container->privates['messenger.transport.in_memory.factory'])) + (int) (isset($container->services['.container.private.profiler'])) + (int) (isset($container->services['validator'])) + (int) (isset($container->privates['monolog.handler.paypal'])) + (int) (isset($container->privates['monolog.handler.main'])) + (int) (isset($container->privates['monolog.handler.firephp'])) + (int) (isset($container->services['security.token_storage'])) + (int) (isset($container->privates['cache.security_expression_language'])) + (int) (isset($container->services['cache.security_is_granted_attribute_expression_language'])) + (int) (isset($container->privates['debug.security.firewall'])) + (int) (isset($container->privates['cache.security_token_verifier'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.admin'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.new_api_admin_user'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.new_api_shop_user'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.shop'])) + (int) (isset($container->services['twig'])) + (int) (isset($container->privates['twig.form.engine'])) + (int) (isset($container->services['doctrine'])) + (int) (isset($container->privates['doctrine.debug_data_holder'])) + (int) (isset($container->privates['form.type.entity'])) + (int) (isset($container->privates['sylius.cache.metadata.resource_collection'])) + (int) (isset($container->services['fos_rest.view_handler'])) + (int) (isset($container->privates['api_platform.cache.route_name_resolver'])) + (int) (isset($container->privates['api_platform.cache.metadata.resource'])) + (int) (isset($container->privates['api_platform.cache.metadata.resource.legacy'])) + (int) (isset($container->privates['api_platform.cache.metadata.property.legacy'])) + (int) (isset($container->privates['api_platform.cache.subresource_operation_factory'])) + (int) (isset($container->privates['api_platform.cache.identifiers_extractor'])) + (int) (isset($container->privates['webpack_encore.tag_renderer'])) + (int) (isset($container->privates['cache.webpack_encore'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[_default]'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[admin]'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[shop]'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[app.admin]'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[app.shop]']))), ['request_stack' => ['?resetRequestFormats'], 'cache.app' => ['reset'], 'cache.system' => ['reset'], 'cache.validator' => ['reset'], 'cache.serializer' => ['reset'], 'cache.annotations' => ['reset'], 'cache.property_info' => ['reset'], 'cache.messenger.restart_workers_signal' => ['reset'], 'mailer.message_logger_listener' => ['reset'], 'translation.locale_switcher' => ['reset'], 'debug.stopwatch' => ['reset'], 'debug.event_dispatcher' => ['reset'], 'debug.log_processor' => ['reset'], 'session_listener' => ['reset'], 'form.choice_list_factory.cached' => ['reset'], 'cache.validator_expression_language' => ['reset'], 'messenger.transport.in_memory.factory' => ['reset'], 'profiler' => ['reset'], 'debug.validator' => ['reset'], 'monolog.handler.paypal' => ['reset'], 'monolog.handler.main' => ['reset'], 'monolog.handler.firephp' => ['reset'], 'security.token_storage' => ['disableUsageTracking', 'setToken'], 'cache.security_expression_language' => ['reset'], 'cache.security_is_granted_attribute_expression_language' => ['reset'], 'debug.security.firewall' => ['reset'], 'cache.security_token_verifier' => ['reset'], 'debug.security.firewall.authenticator.admin' => ['reset'], 'debug.security.firewall.authenticator.new_api_admin_user' => ['reset'], 'debug.security.firewall.authenticator.new_api_shop_user' => ['reset'], 'debug.security.firewall.authenticator.shop' => ['reset'], 'twig' => ['resetGlobals'], 'twig.form.engine' => ['reset'], 'doctrine' => ['reset'], 'doctrine.debug_data_holder' => ['reset'], 'form.type.entity' => ['reset'], 'sylius.cache.metadata.resource_collection' => ['reset'], 'fos_rest.view_handler.default' => ['reset'], 'api_platform.cache.route_name_resolver' => ['reset'], 'api_platform.cache.metadata.resource' => ['reset'], 'api_platform.cache.metadata.resource.legacy' => ['reset'], 'api_platform.cache.metadata.property.legacy' => ['reset'], 'api_platform.cache.subresource_operation_factory' => ['reset'], 'api_platform.cache.identifiers_extractor' => ['reset'], 'webpack_encore.tag_renderer' => ['reset'], 'cache.webpack_encore' => ['reset'], 'webpack_encore.entrypoint_lookup[_default]' => ['reset'], 'webpack_encore.entrypoint_lookup[admin]' => ['reset'], 'webpack_encore.entrypoint_lookup[shop]' => ['reset'], 'webpack_encore.entrypoint_lookup[app.admin]' => ['reset'], 'webpack_encore.entrypoint_lookup[app.shop]' => ['reset']]);
    }
}
