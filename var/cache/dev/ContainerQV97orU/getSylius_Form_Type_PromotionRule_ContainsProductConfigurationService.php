...
class getSylius_Form_Type_PromotionRule_ContainsProductConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.form.type.promotion_rule.contains_product_configuration'] = new \Sylius\Bundle\CoreBundle\Form\Type\Promotion\Rule\ContainsProductConfigurationType(($container->services['sylius.repository.product'] ?? self::getSylius_Repository_ProductService($container)));
    }
}
