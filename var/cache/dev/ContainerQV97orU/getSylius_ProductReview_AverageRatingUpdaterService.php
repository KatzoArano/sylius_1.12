...
class getSylius_ProductReview_AverageRatingUpdaterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.product_review.average_rating_updater'])) {
            return $container->services['sylius.product_review.average_rating_updater'];
        }

        return $container->services['sylius.product_review.average_rating_updater'] = new \Sylius\Bundle\ReviewBundle\Updater\AverageRatingUpdater(($container->services['sylius.average_rating_calculator'] ??= new \Sylius\Component\Review\Calculator\AverageRatingCalculator()), $a);
    }
}
