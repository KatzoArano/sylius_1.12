...
class getSylius_Fixture_ExampleFactory_TaxRateService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.fixture.example_factory.tax_rate'] = new \Sylius\Bundle\CoreBundle\Fixture\Factory\TaxRateExampleFactory(($container->services['sylius.factory.tax_rate'] ??= new \Sylius\Component\Resource\Factory\Factory('App\\Entity\\Taxation\\TaxRate')), ($container->services['sylius.repository.zone'] ?? self::getSylius_Repository_ZoneService($container)), ($container->services['sylius.repository.tax_category'] ?? $container->load('getSylius_Repository_TaxCategoryService')));
    }
}
