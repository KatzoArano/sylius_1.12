...
class getSylius_OauthUser_TokenGenerator_EmailVerificationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.oauth_user.token_generator.email_verification'] = new \Sylius\Component\User\Security\Generator\UniqueTokenGenerator(($container->services['sylius.random_generator'] ??= new \Sylius\Resource\Generator\RandomnessGenerator()), new \Sylius\Component\User\Security\Checker\TokenUniquenessChecker(($container->services['sylius.repository.oauth_user'] ?? $container->load('getSylius_Repository_OauthUserService')), 'emailVerificationToken'), 64);
    }
}
