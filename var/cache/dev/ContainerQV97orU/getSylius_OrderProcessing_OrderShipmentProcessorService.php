...
class getSylius_OrderProcessing_OrderShipmentProcessorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.order_processing.order_shipment_processor'] = new \Sylius\Component\Core\OrderProcessing\OrderShipmentProcessor($a, ($container->services['sylius.factory.shipment'] ??= new \Sylius\Component\Resource\Factory\Factory('App\\Entity\\Shipping\\Shipment')), ($container->services['sylius.shipping_methods_resolver'] ?? self::getSylius_ShippingMethodsResolverService($container)));
    }
}
