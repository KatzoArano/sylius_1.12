...
class getSylius_ShippingCalculatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.shipping_calculator'] = new \Sylius\Component\Shipping\Calculator\DelegatingCalculator(($container->services['sylius.registry.shipping_calculator'] ?? self::getSylius_Registry_ShippingCalculatorService($container)));
    }
}
