...
class getTwig_TemplateCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        ]))->withContext('twig.template_cache_warmer', $container), new \Symfony\Bundle\TwigBundle\TemplateIterator(($container->services['kernel'] ?? $container->get('kernel', 1)), [(\dirname(__DIR__, 4).'/vendor/payplug/sylius-payplug-plugin/src/Resources/views/SyliusShopBundle') => 'SyliusShop', (\dirname(__DIR__, 4).'/vendor/payplug/sylius-payplug-plugin/src/Resources/views/SyliusAdminBundle') => 'SyliusAdmin', (\dirname(__DIR__, 4).'/vendor/payplug/sylius-payplug-plugin/src/Resources/views/SyliusUiBundle') => 'SyliusUi', (\dirname(__DIR__, 4).'/vendor/pagerfanta/pagerfanta/lib/Twig/templates/') => 'Pagerfanta', (\dirname(__DIR__, 4).'/vendor/knplabs/knp-menu/src/Knp/Menu/Resources/views') => NULL, (\dirname(__DIR__, 4).'/templates') => NULL, (\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Resources/views/Email') => 'email', (\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Resources/views/Form') => NULL], (\dirname(__DIR__, 4).'/templates'), []));
    }
}
