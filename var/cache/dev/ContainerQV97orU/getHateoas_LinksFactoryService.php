...
class getHateoas_LinksFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['hateoas.links_factory'] = new \Hateoas\Factory\LinksFactory(($container->privates['hateoas.configuration.metadata_factory'] ?? self::getHateoas_Configuration_MetadataFactoryService($container)), ($container->privates['hateoas.link_factory'] ?? self::getHateoas_LinkFactoryService($container)), ($container->privates['hateoas.serializer.exclusion_manager'] ?? $container->load('getHateoas_Serializer_ExclusionManagerService')));
    }
}
