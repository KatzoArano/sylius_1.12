...
class __TwigTemplate_7f8e6cabe6f8653ce5ba1dec9cb8b742 extends Template
{
    ...
    public function block_subject(array $context, array $blocks = []): iterable
    {
        ...
        // line 4
        yield "    ";
        yield $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.email.user_registration.subject", [], null, (isset($context["localeCode"]) || array_key_exists("localeCode", $context) ? $context["localeCode"] : (function () { throw new RuntimeError('Variable "localeCode" does not exist.', 4, $this->source); })()));
        yield "
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        <div style=\"font-size: 24px;\">
            ";
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.email.user_registration.welcome_to_our_store", [], null, (isset($context["localeCode"]) || array_key_exists("localeCode", $context) ? $context["localeCode"] : (function () { throw new RuntimeError('Variable "localeCode" does not exist.', 13, $this->source); })())), "html", null, true);
        yield "<br>
        </div>
        ";
        // line 15
    ...
    <div style=\"text-align: center;\">
        ...
        if ((($tmp = $this->extensions['Sylius\Bundle\CoreBundle\Twig\BundleLoadedCheckerExtension']->isBundleLoaded("SyliusShopBundle")) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 20
            yield "            <a href=\"";
            yield (isset($context["url"]) || array_key_exists("url", $context) ? $context["url"] : (function () { throw new RuntimeError('Variable "url" does not exist.', 20, $this->source); })());
        ...
        ";
            ...
            // line 24
            yield "            <a href=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["channel"]) || array_key_exists("channel", $context) ? $context["channel"] : (function () { throw new RuntimeError('Variable "channel" does not exist.', 24, $this->source); })()), "hostname", [], "any", false, false, false, 24);
            yield "\" style=\"display: inline-block; text-align: center; background: #1abb9c; padding: 18px 28px; color: #fff; text-decoration: none; border-radius: 3px;\">
                ";
            // line 25
...
";
    ...
    {
        return array (  155 => 28,  149 => 25,  144 => 24,  138 => 21,  133 => 20,  131 => 19,  122 => 15,  117 => 13,  113 => 11,  110 => 10,  107 => 9,  104 => 8,  91 => 7,  77 => 4,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "@SyliusCore/Email/userRegistration.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/CoreBundle/Resources/views/Email/userRegistration.html.twig");
    }
}
