...
class __TwigTemplate_8381e6a3d303d373e4fd126fdb8581d7 extends Template
{
    ...
    <div class=\"ui fluid stackable items\">
        ...
        foreach ($context['_seq'] as $context["key"] => $context["choice_form"]) {
            // line 7
            yield "            ";
            yield from $this->load("@SyliusShop/Checkout/SelectPayment/_choice.html.twig", 7)->unwrap()->yield(CoreExtension::merge($context, ["form" => $context["choice_form"], "method" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 7, $this->source); })()), "method", [], "any", false, false, false, 7), "vars", [], "any", false, false, false, 7), "choices", [], "any", false, false, false, 7), $context["key"], [], "array", false, false, false, 7), "data", [], "any", false, false, false, 7)]));
            // line 8
            yield "        ";
        ...
        if (!$context['_iterated']) {
            // line 9
            yield "            ";
            yield from $this->load("@SyliusShop/Checkout/SelectPayment/_unavailable.html.twig", 9)->unwrap()->yield($context);
            // line 10
            yield "        ";
        }
...
";
    ...
    {
        return array (  106 => 11,  100 => 10,  97 => 9,  84 => 8,  81 => 7,  63 => 6,  58 => 4,  51 => 2,  48 => 1,);
    }
...
", "@SyliusShop/Checkout/SelectPayment/_payment.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/SelectPayment/_payment.html.twig");
    }
}
