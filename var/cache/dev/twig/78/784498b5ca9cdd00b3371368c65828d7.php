...
class __TwigTemplate_0de46c517c4a92282beaa6c62b9461cc extends Template
{
...
(isset($context["shipment"]) || array_key_exists("shipment", $context) ? $context["shipment"] : (function () { throw new RuntimeError('Variable "shipment" does not exist.', 6, $this->source); })()), "order", [], "any", false, false, false, 6), "number", [], "any", false, false, false, 6)), "url" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("sylius_admin_order_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["shipment"]) || array_key_exists("shipment", $context) ? $context["shipment"] : (function () { throw new RuntimeError('Variable "shipment" does not exist.', 6, $this->source); })()), "order", [], "any", false, false, false, 6), "id", [], "any", false, false, false, 6)])], ["label" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.ui.shipments")], ["label" => CoreExtension::getAttribute($this->env, $this->source,         // line 8
...
", "@SyliusAdmin/Shipment/Show/_breadcrumb.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Shipment/Show/_breadcrumb.html.twig");
    }
}
