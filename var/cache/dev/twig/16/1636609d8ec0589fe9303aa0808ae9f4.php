...
class __TwigTemplate_0676897c8ad8e252dd2aedb83bd65b7b extends Template
{
        ...
        <tr>
            ...
            foreach ($context['_seq'] as $context["class"] => $context["files"]) {
                ...
                foreach ($context['_seq'] as $context["file"] => $context["found"]) {
                    ...
                    yield (((($tmp = $context["found"]) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("green") : ("red"));
                    yield "\">
                        ";
                    // line 49
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["file"], "html", null, true);
                    yield " (";
                    yield (((($tmp = $context["found"]) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("found") : ("not found"));
                    yield ")<br/>
                        </span>
                    ";
                }
...
", "@JMSSerializer/Collector/metadata.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/jms/serializer-bundle/Resources/views/Collector/metadata.html.twig");
    }
}
