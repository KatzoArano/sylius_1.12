...
class __TwigTemplate_88f710de232b1266cf6e47fc341b883c extends Template
{
    ...
    public function macro_render_not_table_triggered_handlers($handlers = null, ...$varargs): string|Markup
    {
        ...
        <table>
            ...
            <tr>
                ...
                <th>Handler</th>";
                // line 42
                if ((($tmp = ((array_key_exists("called", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["called"]) || array_key_exists("called", $context) ? $context["called"] : (function () { throw new RuntimeError('Variable "called" does not exist.', 42, $this->source); })()), false)) : (false))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 43
                    yield "<th>Calls</th>
            ...
            <tr>
                ...
                foreach ($context['_seq'] as $context["type"] => $context["calls"]) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                        ...
                        <td class=\"text-right\">";
                        // line 88
                        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["call"], "duration", [], "any", false, false, false, 88)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber((CoreExtension::getAttribute($this->env, $this->source, $context["call"], "duration", [], "any", false, false, false, 88) * 1000), 4), "html", null, true)) : (""));
                        yield "</td>
                    </tr>";
                    }
                    $_parent = $context['_parent'];
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
