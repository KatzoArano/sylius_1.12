...
class __TwigTemplate_93e9b5c2e5fe57c3d6daf0ba96626286 extends Template
{
    ...
    public function block_label(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        if ((($tmp =  !((isset($context["translation_domain"]) || array_key_exists("translation_domain", $context) ? $context["translation_domain"] : (function () { throw new RuntimeError('Variable "translation_domain" does not exist.', 6, $this->source); })()) === false)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 7
    ...
    {
        return array (  85 => 9,  82 => 7,  80 => 6,  78 => 5,  76 => 4,  63 => 3,  40 => 1,);
    }
...
{% endblock %}
", "@KnpMenu/menu.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/knplabs/knp-menu-bundle/templates/menu.html.twig");
    }
}
