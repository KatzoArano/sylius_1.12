...
class __TwigTemplate_470795a8eea93e8554c050ebba3c1eaa extends Template
{
    ...
    <tr>
        ...
        <td>";
        // line 5
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.ui.percentage_discount"), "html", null, true);
        yield "</td>
    </tr>
    <tr>
        <td class=\"five wide\"><strong class=\"gray text\">";
        ...
        <td ";
        // line 9
        yield $this->env->getFunction('sylius_test_html_attribute')->getCallable()("action-amount");
        yield ">
            ";
        // line 10
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extra\Intl\IntlExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 10, $this->source); })()), "configuration", [], "any", false, false, false, 10), "amount", [], "any", false, false, false, 10), [], "percent"), "html", null, true);
        yield "
        </td>
    </tr>
    </tbody>
...
";
    ...
    {
        return array (  71 => 10,  67 => 9,  63 => 8,  57 => 5,  53 => 4,  48 => 1,);
    }
...
", "@SyliusAdmin/CatalogPromotion/Show/Action/percentage_discount.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/CatalogPromotion/Show/Action/percentage_discount.html.twig");
    }
}
