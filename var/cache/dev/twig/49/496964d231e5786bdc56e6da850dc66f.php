...
class __TwigTemplate_23a58395aade42c5922ae406350b1a7c extends Template
{
    ...
    public function block_block_class(array $context, array $blocks = []): iterable
    {
        ...
        yield " cms-container";
        if ((($tmp =  !CoreExtension::getAttribute($this->env, $this->source, (isset($context["block"]) || array_key_exists("block", $context) ? $context["block"] : (function () { throw new RuntimeError('Variable "block" does not exist.', 15, $this->source); })()), "hasParent", [], "method", false, false, false, 15)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield " cms-container-root";
        }
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["settings"]) || array_key_exists("settings", $context) ? $context["settings"] : (function () { throw new RuntimeError('Variable "settings" does not exist.', 15, $this->source); })()), "class", [], "any", false, false, false, 15)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield " ";
    ...
    public function block_block(array $context, array $blocks = []): iterable
    {
        ...
        // line 22
        yield "    ";
        if ((($tmp = (isset($context["decorator"]) || array_key_exists("decorator", $context) ? $context["decorator"] : (function () { throw new RuntimeError('Variable "decorator" does not exist.', 22, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
        ...
        // line 28
        yield "    ";
        if ((($tmp = (isset($context["decorator"]) || array_key_exists("decorator", $context) ? $context["decorator"] : (function () { throw new RuntimeError('Variable "decorator" does not exist.', 28, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
...
{% endblock %}
", "@SonataBlock/Block/block_container.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sonata-project/block-bundle/src/Resources/views/Block/block_container.html.twig");
    }
}
