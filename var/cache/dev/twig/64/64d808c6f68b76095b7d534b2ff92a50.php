...
class __TwigTemplate_25ffe2b07c46942a752603e48bf319a7 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 1, $this->source); })()), "hasPayments", [], "any", false, false, false, 1)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 2
            yield "<div class=\"ui segment\" id=\"payment-state\">
    ";
            // line 3
            yield $this->extensions['Sylius\Bundle\UiBundle\Twig\TemplateEventExtension']->render("sylius.admin.order.show.payments_content", $context);
            yield "
</div>
";
        } else {
            // line 6
            yield "<div class=\"ui segment center aligned\" id=\"no-payments\">
...
";
    ...
    {
        return array (  63 => 8,  59 => 6,  53 => 3,  50 => 2,  48 => 1,);
    }
...
{% endif %}
", "@SyliusAdmin/Order/Show/_payments.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Order/Show/_payments.html.twig");
    }
}
