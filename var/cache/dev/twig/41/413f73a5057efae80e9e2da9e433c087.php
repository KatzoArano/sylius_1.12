...
class __TwigTemplate_e783d974e3296dd2b2228877533857aa extends Template
{
            ...
            <tr>
                ...
                foreach ($context['_seq'] as $context["listener"] => $context["callsPerClass"]) {
                    ...
                    foreach ($context['_seq'] as $context["className"] => $context["callsInfo"]) {
                        ...
                        <td class=\"text-right\">";
                        // line 69
                        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["callsInfo"], "duration", [], "any", false, false, false, 69)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber((CoreExtension::getAttribute($this->env, $this->source, $context["callsInfo"], "duration", [], "any", false, false, false, 69) * 1000), 4), "html", null, true)) : (""));
                        yield "</td>
                    </tr>";
                    }
                    $_parent = $context['_parent'];
...
{%- macro render_table(listeners) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/events.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/jms/serializer-bundle/Resources/views/Collector/events.html.twig");
    }
}
