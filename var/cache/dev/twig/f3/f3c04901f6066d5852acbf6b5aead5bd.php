...
class __TwigTemplate_82c041b4597d660b4a8bbe7c8a04b59d extends Template
{
...
<div class=\"sylius-filters__group\">
    ...
    ";
        // line 9
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "to", [], "any", false, false, false, 9), 'row', ["attr" => ["class" => "sylius-filters__group"]]);
        yield "
</div>
";
    ...
    {
        return array (  62 => 9,  54 => 4,  50 => 2,  48 => 1,);
    }
...
", "@SyliusUi/Grid/Filter/date.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Grid/Filter/date.html.twig");
    }
}
