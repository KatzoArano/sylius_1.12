...
class __TwigTemplate_e80ccac08a3ade2376e7d7ff6657afd8 extends Template
{
...
";
        // line 3
        yield $macros["flags"]->getTemplateForMacro("macro_fromCountryCode", $context, 3, $this->getSourceContext())->macro_fromCountryCode(...[CoreExtension::getAttribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 3, $this->source); })()), "code", [], "any", false, false, false, 3)]);
        yield " ";
...
", "@SyliusAdmin/Country/Grid/Field/name.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Country/Grid/Field/name.html.twig");
    }
}
