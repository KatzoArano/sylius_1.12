...
class __TwigTemplate_6946624e1f98fa501563a6330d815142 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@Pagerfanta/semantic_ui.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@Pagerfanta/semantic_ui.html.twig"));
    ...
    public function block_current_page_link(array $context, array $blocks = []): iterable
    {
        ...
        // line 14
        yield "<div class=\"active item\" aria-current=\"page\">";
    ...
    public function block_ellipsis(array $context, array $blocks = []): iterable
    {
        ...
        // line 34
        yield "<div class=\"disabled item\">&hellip;</div>";
...
{%- block previous_page_link -%}
    <a class=\"item\" href=\"{{- path -}}\" rel=\"prev\">{{- block('previous_page_message') -}}</a>
{%- endblock previous_page_link -%}

{%- block previous_page_link_disabled -%}
    <div class=\"disabled item\">{{- block('previous_page_message') -}}</div>
{%- endblock previous_page_link_disabled -%}

{%- block next_page_link -%}
    <a class=\"item\" href=\"{{- path -}}\" rel=\"next\">{{- block('next_page_message') -}}</a>
{%- endblock next_page_link -%}

{%- block next_page_link_disabled -%}
    <div class=\"disabled item\">{{- block('next_page_message') -}}</div>
{%- endblock next_page_link_disabled -%}

{%- block ellipsis -%}
    <div class=\"disabled item\">&hellip;</div>
{%- endblock ellipsis -%}
", "@Pagerfanta/semantic_ui.html.twig", "/Users/orkatz/Documents/Sylius-Standard-1.12/vendor/pagerfanta/pagerfanta/lib/Twig/templates/semantic_ui.html.twig");
    }
}
