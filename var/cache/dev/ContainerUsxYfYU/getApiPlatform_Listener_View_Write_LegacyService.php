...
class getApiPlatform_Listener_View_Write_LegacyService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['debug.api_platform.data_persister'] ?? self::getDebug_ApiPlatform_DataPersisterService($container));
