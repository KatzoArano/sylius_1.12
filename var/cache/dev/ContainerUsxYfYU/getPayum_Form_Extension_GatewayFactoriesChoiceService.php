...
class getPayum_Form_Extension_GatewayFactoriesChoiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['payum.form.extension.gateway_factories_choice'])) {
            return $container->services['payum.form.extension.gateway_factories_choice'];
        }

        return $container->services['payum.form.extension.gateway_factories_choice'] = new \Payum\Bundle\PayumBundle\Form\Extension\GatewayFactoriesChoiceTypeExtension($a);
    }
}
