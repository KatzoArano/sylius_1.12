 ...
 */
class getSylius_Api_CatalogPromotionSearchFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'sylius.api.catalog_promotion_search_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.api.catalog_promotion_search_filter'])) {
            return $container->services['sylius.api.catalog_promotion_search_filter'];
        }

        return $container->services['sylius.api.catalog_promotion_search_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), NULL, $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['name' => 'partial', 'code' => 'partial', 'state' => 'exact'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? self::getApiPlatform_IdentifiersExtractor_CachedService($container)), ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
