...
class getSyliusDefault_Bus_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['sylius_default.bus.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['Symfony\\Component\\Process\\Messenger\\RunProcessMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.U9HIqfe'] ?? $container->load('get_Messenger_HandlerDescriptor_U9HIqfeService'));
        }, 1), 'Symfony\\Component\\Console\\Messenger\\RunCommandMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.q2kji_9'] ?? $container->load('get_Messenger_HandlerDescriptor_Q2kji9Service'));
            ...
            yield 0 => ($container->privates['.messenger.handler_descriptor.8c0XbKf'] ?? $container->load('get_Messenger_HandlerDescriptor_8c0XbKfService'));
