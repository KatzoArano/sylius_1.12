...
class getSylius_Fixture_ChannelService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.fixture.channel'] = new \Sylius\Bundle\CoreBundle\Fixture\ChannelFixture(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)), ($container->services['sylius.fixture.example_factory.channel'] ?? $container->load('getSylius_Fixture_ExampleFactory_ChannelService')));
    }
}
