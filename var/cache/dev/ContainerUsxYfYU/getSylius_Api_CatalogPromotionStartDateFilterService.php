 ...
 */
class getSylius_Api_CatalogPromotionStartDateFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'sylius.api.catalog_promotion_start_date_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.api.catalog_promotion_start_date_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\DateFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), NULL, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['startDate' => 'exclude_null'], ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
