...
class getUpdateCartHandlerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Sylius\\Bundle\\ApiBundle\\CommandHandler\\Checkout\\UpdateCartHandler'] = new \Sylius\Bundle\ApiBundle\CommandHandler\Checkout\UpdateCartHandler(($container->services['sylius.repository.order'] ?? self::getSylius_Repository_OrderService($container)), $a, $b, ($container->services['Sylius\\Bundle\\CoreBundle\\Resolver\\CustomerResolverInterface'] ?? $container->load('getCustomerResolverInterfaceService')), ($container->services['Sylius\\Bundle\\ApiBundle\\Context\\UserContextInterface'] ?? self::getUserContextInterfaceService($container)));
    }
}
