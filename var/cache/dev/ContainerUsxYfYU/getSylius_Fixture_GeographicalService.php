...
class getSylius_Fixture_GeographicalService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.fixture.geographical'] = new \Sylius\Bundle\CoreBundle\Fixture\GeographicalFixture(($container->services['sylius.factory.country'] ??= new \Sylius\Component\Resource\Factory\Factory('App\\Entity\\Addressing\\Country')), $a, ($container->services['sylius.factory.province'] ??= new \Sylius\Component\Resource\Factory\Factory('App\\Entity\\Addressing\\Province')), $a, ($container->services['Sylius\\Component\\Addressing\\Factory\\ZoneFactoryInterface'] ?? $container->load('getZoneFactoryInterfaceService')), $a);
    }
}
