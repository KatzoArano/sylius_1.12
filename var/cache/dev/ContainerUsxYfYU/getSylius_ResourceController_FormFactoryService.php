...
class getSylius_ResourceController_FormFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sylius.resource_controller.form_factory'] = new \Sylius\Bundle\ResourceBundle\Controller\ResourceFormFactory(($container->services['form.factory'] ?? self::getForm_FactoryService($container)));
    }
}
