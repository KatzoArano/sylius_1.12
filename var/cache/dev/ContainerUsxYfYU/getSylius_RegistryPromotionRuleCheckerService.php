...
class getSylius_RegistryPromotionRuleCheckerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->register('cart_quantity', ($container->services['sylius.promotion_rule_checker.cart_quantity'] ??= new \Sylius\Component\Promotion\Checker\Rule\CartQuantityRuleChecker()));
        ...
        $instance->register('has_taxon', ($container->services['sylius.promotion_rule_checker.has_taxon'] ??= new \Sylius\Component\Core\Promotion\Checker\Rule\HasTaxonRuleChecker()));
        ...
        $instance->register('contains_product', ($container->services['sylius.promotion_rule_checker.contains_product'] ??= new \Sylius\Component\Core\Promotion\Checker\Rule\ContainsProductRuleChecker()));
