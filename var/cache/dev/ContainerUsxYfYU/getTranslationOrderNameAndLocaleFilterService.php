 ...
 */
class getTranslationOrderNameAndLocaleFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'Sylius\Bundle\ApiBundle\Filter\Doctrine\TranslationOrderNameAndLocaleFilter' shared service.
     *
     * @return \Sylius\Bundle\ApiBundle\Filter\Doctrine\TranslationOrderNameAndLocaleFilter
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Bundle/ApiBundle/Filter/Doctrine/TranslationOrderNameAndLocaleFilter.php';

        return $container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\TranslationOrderNameAndLocaleFilter'] = new \Sylius\Bundle\ApiBundle\Filter\Doctrine\TranslationOrderNameAndLocaleFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
