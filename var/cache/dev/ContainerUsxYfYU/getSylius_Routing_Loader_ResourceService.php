...
class getSylius_Routing_Loader_ResourceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sylius.routing.loader.resource'] = new \Sylius\Bundle\ResourceBundle\Routing\ResourceLoader(($container->privates['sylius.resource_registry'] ?? self::getSylius_ResourceRegistryService($container)), new \Sylius\Bundle\ResourceBundle\Routing\RouteFactory());
    }
}
