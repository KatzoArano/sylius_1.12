...
class getSylius_Api_ArchivedShippingMethodsFilterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.api.archived_shipping_methods_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\ExistsFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), NULL, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['archivedAt' => false], 'exists', ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
