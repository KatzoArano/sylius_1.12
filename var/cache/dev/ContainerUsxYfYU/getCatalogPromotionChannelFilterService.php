 ...
 */
class getCatalogPromotionChannelFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'Sylius\Bundle\ApiBundle\Filter\Doctrine\CatalogPromotionChannelFilter' shared service.
     *
     * @return \Sylius\Bundle\ApiBundle\Filter\Doctrine\CatalogPromotionChannelFilter
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Bundle/ApiBundle/Filter/Doctrine/CatalogPromotionChannelFilter.php';

        $a = ($container->privates['api_platform.iri_converter.legacy'] ?? $container->load('getApiPlatform_IriConverter_LegacyService'));

        if (isset($container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\CatalogPromotionChannelFilter'])) {
            return $container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\CatalogPromotionChannelFilter'];
        }

        return $container->services['Sylius\\Bundle\\ApiBundle\\Filter\\Doctrine\\CatalogPromotionChannelFilter'] = new \Sylius\Bundle\ApiBundle\Filter\Doctrine\CatalogPromotionChannelFilter($a, ($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
