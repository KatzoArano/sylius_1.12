 ...
 */
class getMessenger_Transport_MainFailedService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.main_failed' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.main_failed'])) {
            return $container->privates['messenger.transport.main_failed'];
        }

        return $container->privates['messenger.transport.main_failed'] = $a->createTransport($container->getEnv('resolve:SYLIUS_MESSENGER_TRANSPORT_MAIN_FAILED_DSN'), ['transport_name' => 'main_failed'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
