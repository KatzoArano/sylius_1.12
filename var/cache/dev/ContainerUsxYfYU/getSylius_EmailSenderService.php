...
class getSylius_EmailSenderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.email_sender'] = new \Sylius\Component\Mailer\Sender\Sender($a, $b, ($container->services['sylius.email_provider'] ?? $container->load('getSylius_EmailProviderService')), ($container->services['sylius.mailer.default_settings_provider'] ??= new \Sylius\Component\Mailer\Provider\DefaultSettingsProvider('Example.com', 'no-reply@example.com')), ($container->services['Sylius\\Component\\Mailer\\Modifier\\EmailModifierInterface'] ?? $container->load('getEmailModifierInterfaceService')));
    }
}
