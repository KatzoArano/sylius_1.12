...
class getPayum_Listener_ReplyToHttpResponseService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['payum.listener.reply_to_http_response'] = new \Payum\Bundle\PayumBundle\EventListener\ReplyToHttpResponseListener(($container->services['payum.converter.reply_to_http_response'] ??= new \Payum\Bundle\PayumBundle\ReplyToSymfonyResponseConverter()));
    }
}
