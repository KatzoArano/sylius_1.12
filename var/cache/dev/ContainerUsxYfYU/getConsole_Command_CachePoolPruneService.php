...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'sylius.cache.metadata.resource_collection' => ($container->privates['sylius.cache.metadata.resource_collection'] ?? self::getSylius_Cache_Metadata_ResourceCollectionService($container));
            ...
            yield 'api_platform.cache.metadata.resource.legacy' => ($container->privates['api_platform.cache.metadata.resource.legacy'] ?? self::getApiPlatform_Cache_Metadata_Resource_LegacyService($container));
            yield 'api_platform.cache.metadata.property.legacy' => ($container->privates['api_platform.cache.metadata.property.legacy'] ?? self::getApiPlatform_Cache_Metadata_Property_LegacyService($container));
            yield 'api_platform.cache.subresource_operation_factory' => ($container->privates['api_platform.cache.subresource_operation_factory'] ?? self::getApiPlatform_Cache_SubresourceOperationFactoryService($container));
            yield 'api_platform.cache.identifiers_extractor' => ($container->privates['api_platform.cache.identifiers_extractor'] ?? self::getApiPlatform_Cache_IdentifiersExtractorService($container));
