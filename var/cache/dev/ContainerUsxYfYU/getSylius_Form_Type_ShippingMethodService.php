...
class getSylius_Form_Type_ShippingMethodService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.form.type.shipping_method'] = new \Sylius\Bundle\ShippingBundle\Form\Type\ShippingMethodType('App\\Entity\\Shipping\\ShippingMethod', $container->parameters['sylius.form.type.shipping_method.validation_groups'], 'Sylius\\Bundle\\ShippingBundle\\Form\\Type\\ShippingMethodTranslationType', ($container->services['sylius.registry.shipping_calculator'] ?? self::getSylius_Registry_ShippingCalculatorService($container)), ($container->services['sylius.form_registry.shipping_calculator'] ?? $container->load('getSylius_FormRegistry_ShippingCalculatorService')));
    }
}
