...
class getSylius_EmailManager_ShipmentService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.email_manager.shipment'])) {
            return $container->services['sylius.email_manager.shipment'];
        }

        return $container->services['sylius.email_manager.shipment'] = new \Sylius\Bundle\AdminBundle\EmailManager\ShipmentEmailManager($a);
    }
}
