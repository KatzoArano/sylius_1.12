...
class getJmsSerializer_MetadataDriverService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['jms_serializer.metadata_driver'] = new \JMS\Serializer\Metadata\Driver\TypedPropertiesDriver(new \JMS\Serializer\Metadata\Driver\DoctrineTypeDriver(new \Metadata\Driver\DriverChain([new \JMS\Serializer\Metadata\Driver\YamlDriver($a, $b, $c), new \JMS\Serializer\Metadata\Driver\XmlDriver($a, $b, $c), new \JMS\Serializer\Metadata\Driver\AnnotationDriver(new \JMS\Serializer\Metadata\Driver\AttributeDriver\AttributeReader(($container->privates['annotations.cached_reader'] ?? $container->load('getAnnotations_CachedReaderService'))), $b, $c)]), ($container->services['doctrine'] ?? self::getDoctrineService($container)), $c), $c);
    }
}
