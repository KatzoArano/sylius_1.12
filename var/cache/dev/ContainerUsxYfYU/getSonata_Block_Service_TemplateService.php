...
class getSonata_Block_Service_TemplateService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sonata.block.service.template'])) {
            return $container->services['sonata.block.service.template'];
        }

        return $container->services['sonata.block.service.template'] = new \Sonata\BlockBundle\Block\Service\TemplateBlockService($a);
    }
}
