 ...
 */
class getWebpackEncore_EntrypointLookupapp_AdminService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'webpack_encore.entrypoint_lookup[app.admin]' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['webpack_encore.entrypoint_lookup[app.admin]'] = new \Symfony\WebpackEncoreBundle\Asset\EntrypointLookup((\dirname(__DIR__, 4).'/public/build/app/admin/entrypoints.json'), NULL, 'app.admin', true);
    }
}
