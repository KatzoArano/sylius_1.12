 ...
 */
class getSylius_Taxation_OrderItemsTaxesApplicatorService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.taxation.order_items_taxes_applicator'])) {
            return $container->services['sylius.taxation.order_items_taxes_applicator'];
        }

        return $container->services['sylius.taxation.order_items_taxes_applicator'] = new \Sylius\Component\Core\Taxation\Applicator\OrderItemsTaxesApplicator(($container->services['sylius.tax_calculator'] ?? $container->load('getSylius_TaxCalculatorService')), ($container->services['Sylius\\Component\\Order\\Factory\\AdjustmentFactoryInterface'] ?? $container->load('getAdjustmentFactoryInterfaceService')), ($container->services['sylius.integer_distributor'] ??= new \Sylius\Component\Core\Distributor\IntegerDistributor()), $a, ($container->services['sylius.proportional_integer_distributor'] ??= new \Sylius\Component\Core\Distributor\ProportionalIntegerDistributor()));
    }
}
