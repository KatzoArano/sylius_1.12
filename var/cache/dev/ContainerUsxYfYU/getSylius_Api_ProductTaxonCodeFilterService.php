 ...
 */
class getSylius_Api_ProductTaxonCodeFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'sylius.api.product_taxon_code_filter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['sylius.api.product_taxon_code_filter'])) {
            return $container->services['sylius.api.product_taxon_code_filter'];
        }

        return $container->services['sylius.api.product_taxon_code_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), NULL, $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), ['productTaxons.taxon.code' => 'exact'], ($container->privates['api_platform.identifiers_extractor.cached'] ?? self::getApiPlatform_IdentifiersExtractor_CachedService($container)), ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
