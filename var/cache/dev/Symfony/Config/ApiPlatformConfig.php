...
class ApiPlatformConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     * @return $this
     */
    public function metadataBackwardCompatibilityLayer($value): static
    {
    ...
    */
    ...
    /**
     * @default {"versions":[2,3],"api_keys":[],"swagger_ui_extra_configuration":[]}
    */
    ...
    /**
     * @default {"etag":true,"max_age":null,"shared_max_age":null,"vary":["Accept"],"public":null,"invalidation":{"enabled":false,"varnish_urls":[],"max_header_length":7500,"request_options":[],"purger":"api_platform.http_cache.purger.varnish","xkey":{"glue":" "}}}
    */
     ...
     * @template TValue
     * @param TValue $value
     * @default {"enabled":false,"hub_url":null}
    ...
    */
    ...
    /**
     * @default {"contact":{"name":null,"url":null,"email":null},"backward_compatibility_layer":true,"termsOfService":null,"license":{"name":null,"url":null},"swagger_ui_extra_configuration":[]}
    */
