...
require_once __DIR__.\DIRECTORY_SEPARATOR.'SyliusTaxonomy'.\DIRECTORY_SEPARATOR.'ResourcesConfig.php';
 ...
 */
class SyliusTaxonomyConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    private $driver;
    private $resources;
    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('resources', $value)) {
            $this->_usedProperties['resources'] = true;
            $this->resources = new \Symfony\Config\SyliusTaxonomy\ResourcesConfig($value['resources']);
