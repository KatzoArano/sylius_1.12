...
class TokenStorageConfig 
{
     ...
     * @template TValue
     * @param TValue $value
     * @return \Symfony\Config\Payum\Security\TokenStorageConfig\DoctrineConfig|$this
     * @psalm-return (TValue is array ? \Symfony\Config\Payum\Security\TokenStorageConfig\DoctrineConfig : static)
     */
    public function doctrine(string|array $value = []): \Symfony\Config\Payum\Security\TokenStorageConfig\DoctrineConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->doctrine instanceof \Symfony\Config\Payum\Security\TokenStorageConfig\DoctrineConfig) {
            $this->_usedProperties['doctrine'] = true;
     ...
     * @template TValue
     * @param TValue $value
     * @return \Symfony\Config\Payum\Security\TokenStorageConfig\CustomConfig|$this
     * @psalm-return (TValue is array ? \Symfony\Config\Payum\Security\TokenStorageConfig\CustomConfig : static)
     */
    public function custom(string|array $value = []): \Symfony\Config\Payum\Security\TokenStorageConfig\CustomConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->custom instanceof \Symfony\Config\Payum\Security\TokenStorageConfig\CustomConfig) {
            $this->_usedProperties['custom'] = true;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('doctrine', $value)) {
            $this->_usedProperties['doctrine'] = true;
            $this->doctrine = \is_array($value['doctrine']) ? new \Symfony\Config\Payum\Security\TokenStorageConfig\DoctrineConfig($value['doctrine']) : $value['doctrine'];
            unset($value['doctrine']);
        }

        if (array_key_exists('custom', $value)) {
            $this->_usedProperties['custom'] = true;
            $this->custom = \is_array($value['custom']) ? new \Symfony\Config\Payum\Security\TokenStorageConfig\CustomConfig($value['custom']) : $value['custom'];
            unset($value['custom']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['doctrine'])) {
            $output['doctrine'] = $this->doctrine instanceof \Symfony\Config\Payum\Security\TokenStorageConfig\DoctrineConfig ? $this->doctrine->toArray() : $this->doctrine;
        }
        if (isset($this->_usedProperties['custom'])) {
            $output['custom'] = $this->custom instanceof \Symfony\Config\Payum\Security\TokenStorageConfig\CustomConfig ? $this->custom->toArray() : $this->custom;
        }
