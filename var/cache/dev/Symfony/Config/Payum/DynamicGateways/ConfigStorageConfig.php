...
class ConfigStorageConfig 
{
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\DoctrineConfig : static)
     */
    public function doctrine(string|array $value = []): \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\DoctrineConfig|static
    {
        if (!\is_array($value)) {
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\CustomConfig : static)
     */
    public function custom(string|array $value = []): \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\CustomConfig|static
    {
        if (!\is_array($value)) {
