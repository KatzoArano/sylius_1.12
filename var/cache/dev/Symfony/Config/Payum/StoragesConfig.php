...
class StoragesConfig 
{
    ...
    /**
     * @default {"all":true,"gateways":[],"factories":[]}
    */
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\Payum\StoragesConfig\DoctrineConfig : static)
     */
    public function doctrine(string|array $value = []): \Symfony\Config\Payum\StoragesConfig\DoctrineConfig|static
    {
        if (!\is_array($value)) {
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\Payum\StoragesConfig\CustomConfig : static)
     */
    public function custom(string|array $value = []): \Symfony\Config\Payum\StoragesConfig\CustomConfig|static
    {
        if (!\is_array($value)) {
