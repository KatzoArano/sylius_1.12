...
namespace Symfony\Config\SyliusTaxonomy\Resources\Taxon;
    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('classes', $value)) {
            $this->_usedProperties['classes'] = true;
            $this->classes = new \Symfony\Config\SyliusTaxonomy\Resources\Taxon\Translation\ClassesConfig($value['classes']);
            unset($value['classes']);
        }
