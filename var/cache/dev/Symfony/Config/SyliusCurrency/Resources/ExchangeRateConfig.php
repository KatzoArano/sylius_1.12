...
require_once __DIR__.\DIRECTORY_SEPARATOR.'ExchangeRate'.\DIRECTORY_SEPARATOR.'ClassesConfig.php';
    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('classes', $value)) {
            $this->_usedProperties['classes'] = true;
            $this->classes = new \Symfony\Config\SyliusCurrency\Resources\ExchangeRate\ClassesConfig($value['classes']);
            unset($value['classes']);
        }
